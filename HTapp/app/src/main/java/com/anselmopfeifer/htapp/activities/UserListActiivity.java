 ...
 */
public class UserListActiivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dados.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(UserListActiivity.this, adapter.getItem(position).getNome(), Toast.LENGTH_SHORT).show();
            }
        });
